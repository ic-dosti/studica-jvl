...
public class Training extends SubsystemBase
{
   ...
   /**
    ...
    public Training()
    {
        ...
        //Buttons
        start = new DigitalInput(Constants.START);
        stop = new DigitalInput(Constants.STOP);
        reset = new DigitalInput(Constants.RESET);
        EMS = new DigitalInput(Constants.EMS);

        //Leds

        stopped = new DigitalOutput(Constants.STOPPED);
        running = new DigitalOutput(Constants.RUNNING);
    ...
    public void serServoHvat(double degrees)
    {
