...
// Onga karay 
      ...
      case 16: //move sonic and sharp
        double distUS = 10;
        double xSpeed, ySpeed;
        xSpeed = 0.5;
        ySpeed = m_train.getSonicRight()-distUS;

        Right = (xSpeed / 0.866f) - (ySpeed * 0.5f);
        Left = -(-xSpeed / 0.866f) - (ySpeed * 0.5f);
        Back = 0;

        break;

      case 17:
        int c0 = m_train.getCobraRawValue(0); 
        int c1 = m_train.getCobraRawValue(1);
        int c2 = m_train.getCobraRawValue(2); 
        int c3 = m_train.getCobraRawValue(3); 

        Right = (c2+c3)/14000.0f;
        Left = (c0+c1)/14000.0f;
